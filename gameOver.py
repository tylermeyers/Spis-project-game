...
text = font.render('You died! Try again for another chance to defeat the enemies.', True, (0, 0, 0))
# create a rectangular object for the text surface object
textRect = text.get_rect()
#set the center of the rectangular object and position
textRect.center = (screen_length // 2, 180)
...
FPS = 20
#draw button
btnPlay = button((153, 204, 255), 380, screen_height // 2, 110, 70, "Play again")
